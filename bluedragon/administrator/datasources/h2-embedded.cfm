...
<cfoutput>
	...
	<table border="0">
		<tr>
			...
			<td valign="top">
				<textarea name="initstring" id="initstring" rows="4" cols="40" tabindex="13">#dsinfo.initstring#</textarea>
			</td>
		</tr>
		<tr>
					...
					<tr>
						<td>
							<input type="checkbox" name="sqlselect" id="sqlselect" value="true"
									<cfif dsinfo.sqlselect> checked="true"</cfif> tabindex="14" />
							<label for="sqlselect">SELECT</label>
						</td>
						<td>
							<input type="checkbox" name="sqlinsert" id="sqlinsert" value="true"
									<cfif dsinfo.sqlinsert> checked="true"</cfif> tabindex="15" />
					...
					<tr>
						<td>
							<input type="checkbox" name="sqlupdate" id="sqlupdate" value="true"
									<cfif dsinfo.sqlupdate> checked="true"</cfif> tabindex="16" />
							<label for="sqlupdate">UPDATE</label>
						</td>
						<td>
							<input type="checkbox" name="sqldelete" id="sqldelete" value="true"
									<cfif dsinfo.sqldelete> checked="true"</cfif> tabindex="17" />
					...
					<tr>
						<td>
							<input type="checkbox" name="sqlstoredprocedures" id="sqlstoredprocedures" value="true"
									<cfif dsinfo.sqlstoredprocedures> checked="true"</cfif> tabindex="18" />
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="perrequestconnections" id="perrequestconnections" value="true"
						<cfif dsinfo.perrequestconnections> checked="true"</cfif> tabindex="19" />
			</td>
		</tr>
		<tr>
