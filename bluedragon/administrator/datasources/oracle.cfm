...
<cfsavecontent variable="request.content">
  <cfoutput>
	...
	<tr>
	  <td bgcolor="##f0f0f0">Database SID</td>
	  <td>
	    <input name="databasename" id="databasename" type="text" class="span6" maxlength="250" value="#dsinfo.databasename#" 
		   tabindex="2" />
	  </td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td>
	    <input name="username" id="username" type="text" class="span6" maxlength="50" value="#dsinfo.username#" 
		   tabindex="5" />
	  </td>
	</tr>
	<tr>
