...
<cfoutput>
	...
	<h3>Configure Datasource - Oracle (Oracle)</h3>
	<br />
	...
	<table border="0">
		...
		<tr>
			<td><label for="databasename">Database SID</label></td>
			<td>
				<input name="databasename" id="databasename" type="text" size="30" maxlength="250" value="#dsinfo.databasename#" 
						tabindex="2" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input name="username" id="username" type="text" size="30" maxlength="50" value="#dsinfo.username#" 
						tabindex="5" />
			</td>
		</tr>
		<tr>
