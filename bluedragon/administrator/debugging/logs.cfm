...
<cfsavecontent variable="request.content">
	<cfoutput>
		...
		<cfloop index="i" from="1" to="#arrayLen(logFiles)#">
			...
			<tr bgcolor="##ffffff">
				<td width="100">
					<a href="" alt="View Log File" title="View Log File"><img src="../images/page_find.png" border="0" width="16" height="16" /></a>
					<a href="" alt="Download Log File" title="Download Log File"><img src="../images/disk.png" border="0" width="16" height="16" /></a>
					<a href="" alt="Archive Log File" title="Archive Log File"><img src="../images/folder_page.png" border="0" width="16" height="16" /></a>
					<a href="javascript:void(0);" onclick="javascript:deleteLogFile('#logFiles[i].#');" alt="Delete Log File" title="Delete Log File"><img src="../images/cancel.png" border="0" width="16" height="16" /></a>
				</td>
